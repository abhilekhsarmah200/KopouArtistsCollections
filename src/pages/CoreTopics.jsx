...
export default function CoreTopics() {
  return (
    <div id='future-goals' className='relative sm:px-8 px-4 z-10 h-full py-10'>
      <div className="absolute bg-contain sm:bg-fixed inset-0 sm:bg-no-repeat bg-[url('https://res.cloudinary.com/dwkajs0ca/image/upload/v1759980887/KopouArtistsCollectionsIcon/b3v7pwwtdmn0h2ubxqmy.png')] sm:bg-[url('https://res.cloudinary.com/dwkajs0ca/image/upload/v1759806176/KopouArtistsCollectionsIcon/gb2xna6izzq6hhgwmo89.png')] sm:bg-cover md:bg-cover lg:bg-cover opacity-40"></div>
