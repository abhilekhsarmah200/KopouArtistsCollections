...
export default function WordsFromFounder() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-contain xs:bg-cover sm:bg-contain bg-[#faf5ef] sm:bg-[url('https://res.cloudinary.com/dwkajs0ca/image/upload/v1760015977/KopouArtistsCollectionsIcon/Webp/Banner2.webp')] opacity-50"></div>
