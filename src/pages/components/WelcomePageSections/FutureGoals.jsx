...
export default function FutureGoals() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-cover sm:bg-contain bgimage bg-[#faf5ef] sm:bg-[url('https://res.cloudinary.com/dwkajs0ca/image/upload/v1760012721/KopouArtistsCollectionsIcon/Webp/Banner1.webp')] opacity-50"></div>
