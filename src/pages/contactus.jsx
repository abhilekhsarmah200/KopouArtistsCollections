...
drop-shadow-[0_0_25px_rgba(255,255,255,1)]'
          ...
          <div className='max-w-2xl lg:max-w-4xl xl:max-w-6xl 4xl:max-w-[100%] flex lg:flex-row flex-col border border-[gray]/30 bg-white rounded-xl shadow-sm mt-5'>
            <div className='w-full p-6 pb-0 lg:pb-6 flex flex-col gap-2 justify-center'>
              ...
              <p className='text-left montserrat-text text-sm md:text-[1rem] lg:text-xl md:px-4'>
                Connect with Kopou Artists Collection – Your questions,
                feedback, and artistic inquiries are always welcome. Reach out
                to us and let's create something beautiful together...
              </p>
            </div>
