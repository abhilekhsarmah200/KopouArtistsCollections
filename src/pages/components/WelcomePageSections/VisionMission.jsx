...
export default function VisionMission() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-contain xs:bg-cover bg-[#faf5ef] sm:bg-contain bgimage sm:bg-[url('https://res.cloudinary.com/dwkajs0ca/image/upload/v1760016472/KopouArtistsCollectionsIcon/Webp/Banner3.webp')] opacity-50"></div>
