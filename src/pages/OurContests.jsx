        ...
        <div className='lg:max-w-xl z-5 sm:max-w-lg max-w-sm bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2'>
          <div className='relative md:h-full p-6 sm:p-10'>
            <div className='text-sm md:text-xl lg:text-2xl '>
              Welcome to the <b>Kopou Artist Collective</b> Contest Hub! Here,
              you’ll find all the exciting contests and challenges designed to
              inspire and recognize creative talents across art, music, design,
              filmmaking, and more. Explore past and ongoing contests, check out
              participation details, rewards, and deadlines — and be part of a
              growing community that celebrates originality, passion, and
              artistic expression. Join in, showcase your talent, and let your
              creativity shine with Kopou!
            </div>
          </div>
        </div>
      </div>
