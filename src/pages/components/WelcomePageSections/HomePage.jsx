...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bg-cover sm:bg-cover home  inset-0 bg-[#faf5ef] sm:bg-no-repeat sm:bg-[url('https://res.cloudinary.com/dwkajs0ca/image/upload/v1760015626/KopouArtistsCollectionsIcon/Webp/nzn4attnz2x9zgqbkyqh.webp')] opacity-50"></div>
      ...
      <div>
        <img
          ...
          className='lg:h-46 sm:h-34 h-24 absolute top-10 md:top-20 left-5  transform hover:scale-130 rotate-12 hover:rotate-25 transition-all duration-500 ease-in-out cursor-pointer text-[#c23c23] [filter:drop-shadow(0_0_2px_white)_drop-shadow(0_0_1px_white)] hover:[filter:drop-shadow(0_0_4px_white)_drop-shadow(0_0_2px_white)]'
        />
        <img
          loading='lazy'
          title='Kopou Artist Collective icons'
          ...
          className='lg:h-32 sm:h-24 h-18 absolute top-15 md:top-20 right-5 transform hover:scale-130 rotate-12 hover:rotate-25 transition-all duration-500 ease-in-out cursor-pointer text-[#c23c23] [filter:drop-shadow(0_0_2px_white)_drop-shadow(0_0_1px_white)] hover:[filter:drop-shadow(0_0_4px_white)_drop-shadow(0_0_2px_white)]'
        />
        <img
          loading='lazy'
          title='Kopou Artist Collective icons'
          ...
          className='lg:h-42 sm:h-32 h-22 absolute bottom-10 md:bottom-20 left-5 transform hover:scale-130 rotate-12 hover:rotate-25 transition-all duration-500 ease-in-out cursor-pointer text-[#c23c23] [filter:drop-shadow(0_0_2px_white)_drop-shadow(0_0_1px_white)] hover:[filter:drop-shadow(0_0_4px_white)_drop-shadow(0_0_2px_white)]'
        />
        <img
          loading='lazy'
          title='Kopou Artist Collective icons'
          ...
          className='lg:h-42 sm:h-32 h-22 absolute bottom-10 md:bottom-20 right-5 transform hover:scale-130 rotate-12 hover:rotate-25 transition-all duration-500 ease-in-out cursor-pointer text-[#c23c23] [filter:drop-shadow(0_0_2px_white)_drop-shadow(0_0_1px_white)] hover:[filter:drop-shadow(0_0_4px_white)_drop-shadow(0_0_2px_white)]'
        />
      </div>
      {/* <Popup /> */}
    </div>
